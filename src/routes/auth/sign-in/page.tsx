  ...
  return (
    ...
    >
      <div className="w-full max-w-md">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="text-right">
                <div className="text-sm font-medium text-purple-600 transition-colors hover:text-purple-700 hover:underline">
                  Esqueceu sua senha?
                </div>
              </div>
        ...
        {/* Footer */}
        <p className="my-5 flex items-center justify-center gap-1 text-center text-gray-600">
          Novo por aqui?{' '}
          <Link to="/auth/sign-up/page">
            <div className="font-semibold text-purple-600 transition-colors hover:text-purple-700 hover:underline">
